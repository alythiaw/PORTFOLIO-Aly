document.addEventListener('DOMContentLoaded', () => {
    ...
    const textArray = ["GRAPHISTE.", "DEVELOPPEUR JUNIOR", "MONTEUR", "Passionné par l'innovation.", "Créatif et rigoureux.", "Étudiant en Informatique. Je suis aussi dispo pour  des missions freelance."];
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            .then(async (response) => {
                ...
                if (response.status == 200) {
                    ...
                    formStatus.innerHTML = `<span style="color: #006199ff;">${jsonResponse.message || "Une erreur s'est produite."}</span>`;
                }
            })
            .catch(error => {
                console.log(error);
                formStatus.innerHTML = `<span style="color: #d36a08ff;">Oups ! Quelque chose s'est mal passé.</span>`;
            })
            .finally(() => {
